...
0
|| checktplrefresh('./template/dog/search/forum.htm', './template/dog/search/header.htm', 1404051110, '6', './data/template/6_6_search_forum.tpl.php', './template/dog', 'search/forum')
|| checktplrefresh('./template/dog/search/forum.htm', './template/dog/search/pubsearch.htm', 1404051110, '6', './data/template/6_6_search_forum.tpl.php', './template/dog', 'search/forum')
|| checktplrefresh('./template/dog/search/forum.htm', './template/dog/search/thread_list.htm', 1404051110, '6', './data/template/6_6_search_forum.tpl.php', './template/dog', 'search/forum')
|| checktplrefresh('./template/dog/search/forum.htm', './template/dog/search/footer.htm', 1404051110, '6', './data/template/6_6_search_forum.tpl.php', './template/dog', 'search/forum')
|| checktplrefresh('./template/dog/search/forum.htm', './template/dog/common/header_common.htm', 1404051110, '6', './data/template/6_6_search_forum.tpl.php', './template/dog', 'search/forum')
;?>
<!DOCTYPE html>
<html>
<head>
...
<a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a>
<?php } else { ?>
<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">新用户注册</a>
...
<tr>
<td><h1><a href="search.php" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo $_G['style']['styleimgdir'];?>/logo_sc_s.png" alt="<?php echo $_G['setting']['bbname'];?>" /></a></h1></td>
<td>
...
<div class="hm mtw ptw pbw"><h1 class="mtw ptw"><a href="./" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo $_G['style']['styleimgdir'];?>/logo_sc.png" alt="<?php echo $_G['setting']['bbname'];?>" /></a></a></h1></div>
...
<div id="ft" class="w cl sc_ft"><?php if(is_array($_G['setting']['footernavs'])) foreach($_G['setting']['footernavs'] as $nav) { if($nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
