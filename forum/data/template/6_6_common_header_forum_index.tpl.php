...
0
|| checktplrefresh('./template/dog/common/header.htm', './template/dog/common/header_common.htm', 1404098608, '6', './data/template/6_6_common_header_forum_index.tpl.php', './template/dog', 'common/header_forum_index')
|| checktplrefresh('./template/dog/common/header.htm', './template/dog/common/pubsearchform.htm', 1404098608, '6', './data/template/6_6_common_header_forum_index.tpl.php', './template/dog', 'common/header_forum_index')
;?>
<!DOCTYPE html>
<html>
<head>
...
<div class="sub">
<i class="spt"></i>
<a href="javascript:;" id="scbar_type" class="hide" onclick="showMenu(this.id)" hidefocus="true">搜索</a>
<button type="submit" name="searchsubmit" id="scbar_btn" sc="1" value="true" class="opacity">搜索</button>
</div>
<div class="ipt">
...
<div id="newry_topnav" class="nav_box forum_nav">
  <div class="nav_min cl">
    <div class="inner">
      <div class="user_nav">
        ...
        <div id="newry_user">
          <ul id="newry_nav">
            <li id="user_box">
              <span class="txt">
                <a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank">个人中心</a>
                <a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出登录</a>
              </span>
          ...
          <ul id="newry_nav">
            <li id="login_u_box">
              <span class="txt">
                ...
                <?php echo dhtmlspecialchars($_G['cookie']['loginuser']); ?>                </a>
              </span>
              <span class="txt">
        ...
        <div id="newry_user">
          <ul id="newry_nav">
            <li id="login_u_box">
              <span class="txt">
                <a href="home.php?mod=spacecp&amp;ac=usergroup" class="nousername"><?php echo $_G['member']['username'];?></a>
              </span>
              <span class="txt">
                <a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a>
              </span>
      ...
      <span class="spt word">多些陪伴，少些等待。欢迎进入狗狗去哪儿论坛！</span>
    </div>
  </div>
  <!--End Navigation-->
