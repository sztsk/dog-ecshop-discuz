...
</div><?php echo adshow("text/wp a_t");?><div class="boardnav">
...
<div class="mn">
<div class="bml pbn f_display_top">

<div class="bm_h cl">
<h1 class="xs2">
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" class="c_title"><?php echo $_G['forum']['name'];?></a>
...
<div class="moder">
版主: 
<span><?php echo $moderatedby;?></span>
</div>
<?php } ?>
</div>
...
<div class="desc">
<strong class="tl">板块概况：</strong>
<div class="ptn xg2"><?php echo $_G['forum']['description'];?></div>
</div>
<?php } ?>
</div>
<?php } if(!empty($forumarchive)) { ?>
...
<div class="bm_h cl">
<span class="o">
<img id="recommendgroups_<?php echo $_G['forum']['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $collapseimg['recommendgroups'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('recommendgroups_<?php echo $_G['forum']['fid'];?>');" />
</span>
...
<a href="javascript:;" id="newspecial" class="new_tie spt" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_g['forum']['allowspecialonly'] && empty($_g['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发新帖</a>
<?php } ?>
...
<?php } ?>
<a id="filter_special" href="javascript:;" class="showmenu <?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)"><?php if($_GET['specialtype'] == 'poll') { ?>投票<?php } elseif($_GET['specialtype'] == 'trade') { ?>商品<?php } elseif($_GET['specialtype'] == 'reward') { ?>悬赏<?php } elseif($_GET['specialtype'] == 'activity') { ?>活动<?php } elseif($_GET['specialtype'] == 'debate') { ?>辩论<?php } else { ?>全部主题<?php } ?></a>&nbsp;						
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">热帖</a>&nbsp;
...
<a id="filter_dateline" href="javascript:;" class="showmenu <?php if($_GET['dateline']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">更多</a>&nbsp;
