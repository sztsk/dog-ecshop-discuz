...
<!-- dog footer start -->
<div class="mod_ft" id="ft">
    <div class="inner">
        <b class="spt mod_ft_logo"></b>
        <ul class="mod_ft_list clear">
            <li><a href="/index.html">主页</a></li>
            <li><a href="/forum/">论坛入口</a></li>
            <li><a href="/download.html">APP下载</a></li>
            <li><a href="/vip.html">会员卡</a></li>
            <li><a href="/contact.html">联系我们</a></li>
        </ul>
        <a class="spt mod_ft_email" href="##">Email</a>
    </div>
</div>
<script src="template/dog/style/js/scrolltop.js" type="text/javascript"></script>
<!-- dog footer end -->
...
<script type="text/javascript">_attachEvent(window, 'scroll', function () { showTopDW(); });checkBlind();</script>
