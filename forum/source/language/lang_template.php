...
$lang = array (
  ...
  'logout' => '退出',
  'my_nav' => '快捷导航',
  'my_nav_login' => '请 <a href="javascript:;" class="xi2" onclick="lsSubmit()"><strong>登录</strong></a> 后使用快捷导航<br />没有帐号？<a href="/shop/user.php?act=register&back_act=/forum/forum.php" class="xi2 xw1">$_G[\'setting\'][\'reglinkname\']</a>',
  'open_diy' => '打开 DIY 面板',
  'pm_center' => '消息',
