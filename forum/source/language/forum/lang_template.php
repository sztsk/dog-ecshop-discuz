...
$lang = array (
  ...
  'quick_post' => '快速发帖',
  'select_thread_catgory' => '选择地区',//'选择主题分类',
  ...
  'attach_nopermission_login' => '您需要 <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a> 才可以下载或查看，没有帐号？<a href="/shop/user.php?act=register&back_act=/forum/forum.php" title="注册帐号">{$_G[setting][reglinkname]}</a>',
