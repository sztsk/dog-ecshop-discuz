...
$lang = array (
  ...
  'attach_nopermission_login' => '您需要 <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a> 才可以下载或查看，没有帐号？<a href="/shop/user.php?act=register" title="注册帐号">{$_G[setting][reglinkname]}</a>',
