...
$lang = array (
  'getpassword' => '找回密码',
  'login_guest' => '没有帐号？<a href="/shop/user.php?act=register&back_act=/forum/forum.php">{$_G[setting][reglinkname]}</a>',
  'new_password' => '新密码',
  ...
  'invite_code' => '邀请码',
  'login_inactive' => '放弃激活，现在<a href="/shop/user.php?act=register&back_act=/forum/forum.php">{$_G[setting][reglinkname]}</a>',
  'login_now' => '已有帐号？现在登录',
